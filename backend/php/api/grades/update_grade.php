...
$sql = "UPDATE grades SET unit1_marks = ?, unit2_marks = ?, unit3_marks = ?, lab_internal1_marks = ?, lab_internal2_marks = ?, external_lab_marks = ?, semester_exam_marks = ?, total_marks = ?, grade = ? WHERE id = ?";

$stmt = $pdo->prepare($sql);

if ($stmt->execute([$unit1_marks, $unit2_marks, $unit3_marks, $lab_internal1_marks, $lab_internal2_marks, $external_lab_marks, $semester_exam_marks, $total_marks, $grade, $grade_id])) {
